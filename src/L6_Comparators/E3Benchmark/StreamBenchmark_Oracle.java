...
public final class StreamBenchmark_Oracle {
    ...
    public static void main(String[] args) {                               // (17)
        ...
        xqtFunctions(StreamBenchmark_Oracle::seqSumRangeClosed,
                StreamBenchmark_Oracle::paraSumRangeClosed);

        System.out.println("Streams created with the iterate() method:");    // (19)
        System.out.println(" Size Sequential Parallel");
        xqtFunctions(StreamBenchmark_Oracle::seqSumIterate,
                StreamBenchmark_Oracle::paraSumIterate);

        System.out.println("Iterative solution with an explicit loop:");     // (20)

        System.out.println(" Size Iterative");

        xqtFunctions(StreamBenchmark_Oracle::iterSumLoop);
